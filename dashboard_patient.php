    ...
    <div class="container">
        ...
        <div class="sidebar">
            <ul>
                ...
                <li><a href="#"><i class="fas fa-envelope"></i>SMS & Whatsapp Notifications</a></li>
                <!-- <li><a href="#"><i class="fas fa-cog"></i>Settings</a></li> -->
                <li><a href="logoutpatient.php"><i class="fas fa-sign-out-alt"></i>Logout</a></li>
            </ul>
        </div>

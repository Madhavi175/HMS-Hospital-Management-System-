...
if (isset($_POST['submit'])) {
    ...
    if (empty($Username) || empty($Password)) {
        header("location:../view_patientlogin.php?msg=Username and Password are required");
        exit;
    } else {
        $sql = mysqli_query($db, "SELECT * FROM admin_patient WHERE Email='$Username' AND Password='$Password'");
        ...
        if (mysqli_num_rows($sql) > 0) {
            ...
            header('location:view_patientlogin.php');
            exit;
        } else {
            header("location:view_patientlogin.php?msg=Username and Password are Wrong!");
            exit;
        }
    }
}
